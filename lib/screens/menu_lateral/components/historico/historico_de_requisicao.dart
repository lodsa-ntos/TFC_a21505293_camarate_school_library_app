...
class _HistoricoDeRequisicaoState extends State<HistoricoDeRequisicao> {
  @override
  void initState() {
    super.initState();
                                    ...
                                    case ConnectionState.none:
                                      return Row(
                                        ...
                                        children: const <Widget>[
                                          Text(
                                              "Sem obras requisitados para mostrar...")
                                        ],
                                      );
...
class HistoricoDeRequisicao extends StatefulWidget {
  const HistoricoDeRequisicao({Key? key}) : super(key: key);

  @override
  State<HistoricoDeRequisicao> createState() => _HistoricoDeRequisicaoState();
}
