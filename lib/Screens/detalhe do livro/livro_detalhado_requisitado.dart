...
class MeuLivroRequisitadoEDetalhado extends StatefulWidget {
  const MeuLivroRequisitadoEDetalhado({
    Key? key,
    required this.livro,
  }) : super(key: key);
  ...
  @override
  State<MeuLivroRequisitadoEDetalhado> createState() =>
      _MeuLivroRequisitadoEDetalhadoState();
}

class _MeuLivroRequisitadoEDetalhadoState
    extends State<MeuLivroRequisitadoEDetalhado> {
  @override
    ...
    return BottomAppBar(
      ...
      child: Container(
        ...
        child: ElevatedButton(
          ...
          onPressed: DateTime.daysPerWeek == 10
              ? () {}
